...
class MenubarinActive extends StatefulWidget {
  const MenubarinActive({Key? key}) : super(key: key);

  @override
  State<MenubarinActive> createState() => _MenubarinActiveState();
}

class _MenubarinActiveState extends State<MenubarinActive> {
  int currentIndex = 0;
  final Screens = [
