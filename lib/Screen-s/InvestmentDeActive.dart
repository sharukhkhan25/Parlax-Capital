...
import 'package:projectone/Screen-s/MenubarInActive.dart';

class InvestmentDeActive extends StatefulWidget {
  const InvestmentDeActive({Key? key}) : super(key: key);

  @override
  State<InvestmentDeActive> createState() => _InvestmentDeActiveState();
}

class _InvestmentDeActiveState extends State<InvestmentDeActive> {
  @override
                    ...
                    child: GestureDetector(
                      onTap: () {
                        Navigator.pushReplacement(
                          context,
                          MaterialPageRoute(
                            builder: (context) => const MenubarinActive(),
                          ),
                        );
                      },
                      child: const Text(
